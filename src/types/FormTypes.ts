...
const validContactFormNames = z.enum(["name", "email", "link", "message"]);
const validLoginFormNames = z.enum(["email", "password"]);
const validRegisterFormNames = z.enum(["name", "email", "password", "confirm_password"]);
