	...
	return (
		<div className="flex flex-row gap-4 items-center p-3 shadow-md rounded-2xl bg-white dark:bg-black">
			...
			<div className="flex flex-col gap-1 max-h-full overflow-hidden">
				<h1 className="text-lg font-bold ~max-w-sm/lg overflow-hidden whitespace-nowrap text-ellipsis">
					{title}
				</h1>
				<p className="text-sm ~max-w-sm/lg overflow-hidden whitespace-nowrap text-ellipsis">
					{description}
				</p>
